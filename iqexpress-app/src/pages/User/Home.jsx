...
function Home() {
  return (
    <>
      {/* This style tag is added to include the necessary CSS for animations. */}
      ...
      <section className="hero py-5 text-white bg-dark">
        <div className="container text-center">
          ...
          <a href="/track" className="btn btn-primary btn-lg me-3">
            Track Your Shipment
          </a>
      ...
      {/* Why Choose Us / About Us Section - Wrapped for a slide-up animation */}
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6 mb-4 mb-lg-0">
                ...
                <a href="/about" className="btn btn-info mt-3">Learn More About Us</a>
              </div>
      ...
      {/* Services/Features Section - Wrapped for a fade-in animation */}
      <AnimateOnScroll animationClass="fade-in">
        <section className="features py-5">
          <div className="container">
            ...
            <div className="text-center mt-4">
              <a href="/services" className="btn btn-lg btn-secondary">View All Services</a>
            </div>
          </div>
        </section>
      </AnimateOnScroll>

      {/* Call to Action Section - Wrapped for a slide-up animation */}
      <AnimateOnScroll animationClass="slide-up">
        <section className="py-5 bg-primary text-white text-center">
          <div className="container">
            ...
            <a href="/contact" className="btn btn-light btn-lg me-3">
              Contact Us Today
            </a>
            <a href="/track" className="btn btn-outline-light btn-lg">
              Track Your Delivery
            </a>
          </div>
        </section>
